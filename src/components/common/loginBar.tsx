  ...
  render() {
    return (
      <div className="LoginBar w-2/12 flex items-center justify-end mr-2  ">
        <div className=" px-4  border border-solid border-black rounded-full mr-2">
        <a className=" w-14 text-sm " href="/login">
            <FontAwesomeIcon className="text-gray-700 pl-2 pr-4" icon={faPIRightToBracket} fade  
            />Login</a>
        </div>
     
        <div className="px-4  border border-solid border-white rounded-full text-white bg-black">
