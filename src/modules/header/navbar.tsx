        ...
        <div className = "Home-navbar h-9 w-4/12 ">
            <ul className = "justify-around flex w-full ">
                <li   className="nav__home py-1 self-center mt-1 -ml-5 " >
                    <Link onClick={this.handleClick}  className="px-1.5 py-2 text-gray-300 font-thin hover:bg-gray-700 hover:opacity-50 border border-gray-900 hover:border-gray-600   hover:rounded-sm"  to = "/"
                        ><FontAwesomeIcon className=" pr-2" icon={faHome} 
                            /> Home
                    </Link> 
                </li>
                <li  className="nav__docs py-1 self-center mt-1    ">
                    <Link onClick={this.handleClick} className="px-1.5 py-2 text-gray-300 font-thin hover:bg-gray-700 hover:opacity-50 border border-gray-900 hover:border-gray-600   hover:rounded-sm"  to = "/docs"
                        ><FontAwesomeIcon className=" pr-2 " icon={faBookOpen} 
                            /> Docs
                    </Link> 
                    </li>
                <li  className="nav__blog py-1 self-center mt-1    ">
                    <Link onClick={this.handleClick} className="px-1.5 py-2 text-gray-300 font-thin hover:bg-gray-700 hover:opacity-50 border border-gray-900 hover:border-gray-600   hover:rounded-sm"  to = "/blog"
                        ><FontAwesomeIcon className=" pr-3 " icon={faBlog} 
                            /> Blog
                    </Link> 
                    </li>
                <li  className="nav__writing py-1 self-center mt-1    ">
                    <Link onClick={this.handleClick} className="px-1.5 py-2 text-gray-300 font-thin hover:bg-gray-700 hover:opacity-50 border border-gray-900 hover:border-gray-600   hover:rounded-sm"  to = "/writing"
                ...
                <li  className="nav__study py-1 self-center mt-1    ">
                    <Link onClick={this.handleClick} className="px-1.5 py-2 text-gray-300 font-thin hover:bg-gray-700 hover:opacity-50 border border-gray-900 hover:border-gray-600   hover:rounded-sm"  to = "/study"
